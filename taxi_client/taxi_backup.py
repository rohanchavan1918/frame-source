...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Login to FRAME", font=controller.title_font)
        ...
        button1 = tk.Button(self, text="Scan face to Login",command=self.login)
        # if StartPage.login_status == True:
